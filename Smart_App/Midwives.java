...
public abstract class Midwives {
	...
	public Midwives(int theid, String theName,String theUsername,String theEmail, String thePassword, boolean isActive,
			boolean isAdmin, String thejob_occupation, String thejob_level, String theprimary_phone, String thesecondary_phone) {
	...
	public String toString()
	    {
		   return String.format( "%s %s%s",getId(),getName(),getEmail(),getPassword(),isActive(),isAdmin(),getJob_occupation(),getJob_level(),getPrimary_phone(),getSecondary_phone());
	    } 
}
